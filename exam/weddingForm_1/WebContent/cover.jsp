...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	.bgimg-1 {
		background-image: url('./image/cover/wedding01.jpg');
		min-height: 100%;
	}
	
	/* Second image (Portfolio) */
	.bgimg-2 {
		background-image: url("./image/cover/wedding_2.jpg");
		min-height: 400px;
	}
...
<body>
	...
	<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
		<div class="w3-display-middle" style="white-space: nowrap;">
			<a href="./index.jsp" class="w3-button w3-hover-black"> 
	...
	<div class="w3-content w3-container w3-padding-64" id="about">
		...
		<div class="w3-row">
			<img class="w3-center w3-col m12" src="./image/cover/mobileInfo.jpg">
		</div>
		...
		<div class="w3-row">
			<div class="w3-col m6 w3-center w3-padding-large">
				<img src="./image/cover/hall_2.jpg"
