...
<body>
   ...
   <div id="blank"></div>
      ...
      <form action="./${board}Write.${board}" method="post" id="frm">

         <input type="hidden" name="num" value="${param.num}" class="form-control">
         <c:if test="${board eq 'qna'}">
            <p class="panel-body">
               공개글 <input type="radio" name="opencheck" value="open" id="open" checked="checked"> 
                  비밀글 <input type="radio" name="opencheck" value="hide" id="hide">
            
            <div id="pw" class="panel-body">
